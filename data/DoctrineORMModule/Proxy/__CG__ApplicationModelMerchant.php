 ...
 */
class Merchant extends \Application\Model\Merchant implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Model\\Merchant' . "\0" . 'id', '' . "\0" . 'Application\\Model\\Merchant' . "\0" . 'name', '' . "\0" . 'Application\\Model\\Merchant' . "\0" . 'transactions');
        }
