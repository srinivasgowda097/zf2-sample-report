 ...
 */
class Currency extends \Application\Model\Currency implements \Doctrine\ORM\Proxy\Proxy
{
    /**
...
//
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Model\\Currency' . "\0" . 'id', '' . "\0" . 'Application\\Model\\Currency' . "\0" . 'code', '' . "\0" . 'Application\\Model\\Currency' . "\0" . 'symbol', '' . "\0" . 'Application\\Model\\Currency' . "\0" . 'transactions');
        }
